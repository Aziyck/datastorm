...
years_future = list(range(2025, 2038 + vals))
...
future_df = future_df.tail(vals)
print(future_df)

# --- Încarcare modele ---
loaded_lin = joblib.load(f"models/{chosen_scenario}_Linear.pkl")
loaded_ridge = joblib.load(f"models/{chosen_scenario}_Ridge.pkl")
loaded_lasso = joblib.load(f"models/{chosen_scenario}_Lasso.pkl")

lin_reg = loaded_lin['model']
ridge = loaded_ridge['model']
lasso = loaded_lasso['model']

cols_lin = loaded_lin['X_columns']
cols_ridge = loaded_ridge['X_columns']
cols_lasso = loaded_lasso['X_columns']

# --- Pregătire X pentru predicții ---
X_lin = future_df[cols_lin]
X_ridge = future_df[cols_ridge]
X_lasso = future_df[cols_lasso]

# --- Valorile reale pentru y ---
y = future_df['PnL_net_index']
...
print("Pred lin = ", y_pred_lin)
print("Pred ridge = ", y_pred_ridge)
print("Pred lasso = ", y_pred_lasso)
# --- Plot comparativ ---
